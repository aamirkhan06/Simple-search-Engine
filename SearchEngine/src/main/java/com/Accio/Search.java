...
@WebServlet("/Search") //route to search
public class Search extends HttpServlet
{
    protected  void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException
    {
        ...
        try {
            //to also store the query of the results for history feature
            ...
            //to check if program is working that is displaying results arraylist in console
